...
export class WfcEngine {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WfcEngineFinalization.unregister(this);
        return ptr;
    }
    free() {
     ...
     * @returns {any}
     */
    generate_placements(grid_q, grid_r, seed, offset_x, offset_z) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wfcengine_generate_placements(retptr, this.__wbg_ptr, grid_q, grid_r, seed, offset_x, offset_z);
...
if (Symbol.dispose) WfcEngine.prototype[Symbol.dispose] = WfcEngine.prototype.free;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./wfc_core_bg.js": import0,
    };
}

const WfcEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wfcengine_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('wfc_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
